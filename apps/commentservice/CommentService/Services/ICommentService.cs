...
{
    public interface ICommentService : ICommentEventHandler
    {
        ...
        Task<Result<Dictionary<Guid, int>>> GetReplyCountsAsync(IEnumerable<Guid> commentIds);
        Task<Result<Dictionary<Guid, int>>> GetCommentCountsAsync(IEnumerable<Guid> postIds);
